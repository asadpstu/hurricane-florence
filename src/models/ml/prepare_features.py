...
BUILD = "ML_RETAINED_EXOGENOUS_HIGHFLOW_FEATURE_DATASET"
...
def main():
    ...
    dataset = a.output_dir / "ml_features_2015_2017.csv.gz"
    metadata = a.output_dir / "ml_feature_metadata.json"
    qcfile = a.output_dir / "ml_feature_qc.csv"
