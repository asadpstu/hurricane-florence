...
BUILD = "ML_V4_EXOGENOUS_HIGHFLOW_EVENT_SELECTION"
...
def main():
    ...
    print("ML V4 - EXOGENOUS HIGH-FLOW-AWARE XGBOOST")
    print("="*112)
    ...
    status="PASS_ML_V4_VALIDATION" if failures==0 else "FAIL_ML_V4_VALIDATION_QUALITY"

    a.output_dir.mkdir(parents=True,exist_ok=True)
    model_path=a.output_dir/"ml_v4_model.joblib"
    ...
    write_csv(results,a.output_dir/"ml_v4_candidate_metrics.csv")
    write_csv(pred,a.output_dir/"ml_v4_validation_predictions.csv")
    write_csv(ev,a.output_dir/"ml_v4_validation_event_metrics.csv")
    ...
    write_csv(imp,a.output_dir/"ml_v4_feature_importance.csv")
    metadata={
    ...
    write_json(metadata,a.output_dir/"ml_v4_metadata.json")
